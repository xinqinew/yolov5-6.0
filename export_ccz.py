...
@torch.no_grad()
def run(data=ROOT / 'ccz2/data.yaml',  # 'dataset.yaml path'
        weights=ROOT / 'ccz2/ccz.pt',  # weights path
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'ccz2/data.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', type=str, default=ROOT / 'ccz2/ccz.pt', help='weights path')
